...
export function HeroSection() {
  ...
  return (
    ...
    >
      <GridBackground />
      <FloatingElements count={8} interactive animatePulse motionScale={0.9} />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-24 pb-32 text-center">
        ...
        >
          Автоматический план-факт анализ бюджета подразделений с&nbsp;интеграцией
          1С. Дашборды, KPI, отчёты&nbsp;&mdash; всё в&nbsp;одном месте.
        </motion.p>
